...
fun PaymentView(
    ...
    Box(
        ...
        Column(modifier = Modifier
            ...
            PaymentItem("Credit Card") {
                onEvent(PaymentUiEvent.CreditCardSelected)
            }

            PaymentItem("Pix") {
                onEvent(PaymentUiEvent.PixSelected)
            }

            TextButton(
                onClick = {
                  onEvent(PaymentUiEvent.BackButtonPressed)
                },
...
@Composable
private fun PaymentItem(label: String, onClick: () -> Unit): Unit {
